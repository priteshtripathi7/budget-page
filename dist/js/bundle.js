...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _uicontroller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./uicontroller */ \"./src/js/uicontroller.js\");\n/* harmony import */ var _datacontroller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./datacontroller */ \"./src/js/datacontroller.js\");\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n\n\n\n\nvar setupEventListners = function setupEventListners() {\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_2__[\"DOMSelector\"].btn).addEventListener('click', ctrlAddEvents);\n  document.addEventListener('keypress', function (e) {\n    if (e.keyCode == 13 || e.which == 13) {\n      ctrlAddEvents();\n    }\n  });\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_2__[\"DOMSelector\"].conatiner).addEventListener('click', ctrlDeleteEvents);\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_2__[\"DOMSelector\"].type).addEventListener('change', _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"changeType\"]);\n};\n\nvar dataCalculator = function dataCalculator() {\n  //1.Calculate the Budget\n  data.calculateBudget(); //2.Return budget.\n\n  var calculatedBudget = data.returnData(); //3.Display the budget on the UI\n\n  _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"displayBudget\"](calculatedBudget);\n};\n\nvar percentageCalculator = function percentageCalculator() {\n  //1.Calculate Percentages\n  data.calculatePercentages(); //2.Get the percentages\n\n  var percentageArr = dataCtrl.getPercentages(); //3.Display the percentage sun the UI\n\n  _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"displayPercentages\"](percentageArr);\n};\n\nvar ctrlAddEvents = function ctrlAddEvents() {\n  //1.Get Inputs\n  var Input = _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"getInput\"](); //Checking for valid input fields\n\n  if (Input.inputDescription !== '' && !isNaN(Input.inputValue)) {\n    //2.Add items to the data controller.\n    var newItem = data.updateData(Input.inputType, Input.inputDescription, Input.inputValue); //3.Add item to the UI\n\n    _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"addItemToDOM\"](newItem, Input.inputType); //4.Clearing the fields.\n\n    _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"clearInputs\"](); //5. Update the budget.\n\n    dataCalculator(); //6.Update percentages\n\n    percentageCalculator();\n  }\n};\n\nvar ctrlDeleteEvents = function ctrlDeleteEvents(event) {\n  var item, sliceID, ID, type;\n  item = event.target.parentNode.parentNode.parentNode.parentNode.id;\n\n  if (item) {\n    sliceID = item.split('-');\n    type = sliceID[0];\n    ID = parseInt(sliceID[1]); //1.Update the data structure\n\n    data.deleteData(type, ID); //2.Update the UI\n\n    _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"deleteItem\"](item); //3.Update and calculate the budget\n\n    dataCalculator(); //4.Update percentages\n\n    percentageCalculator();\n  }\n};\n\nvar init = function init() {\n  _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"diaplayDate\"]();\n  _uicontroller__WEBPACK_IMPORTED_MODULE_0__[\"displayBudget\"]({\n    budget: 0,\n    totalInc: 0,\n    totalExp: 0,\n    per: -1\n  });\n  setupEventListners();\n  data = new _datacontroller__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n};\n\ninit();\n\n//# sourceURL=webpack:///./src/js/controller.js?");
...
/*!********************************!*\
  !*** ./src/js/uicontroller.js ***!
  \********************************/
/*! exports provided: getInput, addItemToDOM, clearInputs, displayBudget, displayPercentages, diaplayDate, deleteItem, changeType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getInput\", function() { return getInput; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addItemToDOM\", function() { return addItemToDOM; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearInputs\", function() { return clearInputs; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayBudget\", function() { return displayBudget; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayPercentages\", function() { return displayPercentages; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"diaplayDate\", function() { return diaplayDate; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteItem\", function() { return deleteItem; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"changeType\", function() { return changeType; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\nvar formatDisplay = function formatDisplay(num, type) {\n  var numSplit, _int, dec, type;\n\n  num = Math.abs(num);\n  num = num.toFixed(2);\n  numSplit = num.split('.');\n  _int = numSplit[0];\n\n  if (_int.length > 3) {\n    _int = _int.substr(0, _int.length - 3) + ',' + _int.substr(_int.length - 3, 3); //input 23510, output 23,510\n  }\n\n  dec = numSplit[1];\n  return (type === 'exp' ? '-' : '+') + ' ' + _int + '.' + dec;\n};\n\nvar nodeListForEach = function nodeListForEach(list, callback) {\n  for (var i = 0; i < list.length; i++) {\n    callback(list[i], i);\n  }\n};\n\nvar getInput = function getInput() {\n  return {\n    inputType: document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].type).value,\n    inputDescription: document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].description).value,\n    inputValue: parseFloat(document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].value).value)\n  };\n};\nvar addItemToDOM = function addItemToDOM(ele, type) {\n  var textToBeString, newTextToBeString, placeToInsert;\n\n  function callDB() {\n    return _callDB.apply(this, arguments);\n  }\n\n  function _callDB() {\n    _callDB = _asyncToGenerator(\n    /*#__PURE__*/\n    regeneratorRuntime.mark(function _callee() {\n      var res, aft;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.prev = 0;\n              _context.next = 3;\n              return fetch('http://localhost:3000/', {\n                method: 'get'\n              });\n\n            case 3:\n              res = _context.sent;\n              console.log(res);\n              _context.next = 7;\n              return res.json();\n\n            case 7:\n              aft = _context.sent;\n              aft.forEach(function (ele) {\n                //Create new HTML String\n                if (ele.type === 'inc') {\n                  placeToInsert = _base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].incomeContainer;\n                  textToBeString = '<div class=\"item clearfix\" id=\"inc-%id%\"><div class=\"item__description\">%description%</div><div class=\"right clearfix\"><div class=\"item__value\">%value%</div><div class=\"item__delete\"><button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button></div></div></div>';\n                } else if (type === 'exp') {\n                  placeToInsert = _base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].expenseContainer;\n                  textToBeString = '<div class=\"item clearfix\" id=\"exp-%id%\"><div class=\"item__description\">%description%</div><div class=\"right clearfix\"><div class=\"item__value\">%value%</div><div class=\"item__percentage\">21%</div><div class=\"item__delete\"><button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button></div></div></div>';\n                }\n\n                newTextToBeString = textToBeString.replace('%id%', ele.id);\n                newTextToBeString = newTextToBeString.replace('%description%', ele.name);\n                newTextToBeString = newTextToBeString.replace('%value%', formatDisplay(ele.value, type)); //Insert the new object into DOM\n\n                document.querySelector(placeToInsert).insertAdjacentHTML('beforeend', newTextToBeString);\n              });\n              _context.next = 14;\n              break;\n\n            case 11:\n              _context.prev = 11;\n              _context.t0 = _context[\"catch\"](0);\n              console.log(_context.t0);\n\n            case 14:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, null, [[0, 11]]);\n    }));\n    return _callDB.apply(this, arguments);\n  }\n\n  callDB(); //Create new HTML String\n\n  if (type === 'inc') {\n    placeToInsert = _base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].incomeContainer;\n    textToBeString = '<div class=\"item clearfix\" id=\"inc-%id%\"><div class=\"item__description\">%description%</div><div class=\"right clearfix\"><div class=\"item__value\">%value%</div><div class=\"item__delete\"><button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button></div></div></div>';\n  } else if (type === 'exp') {\n    placeToInsert = _base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].expenseContainer;\n    textToBeString = '<div class=\"item clearfix\" id=\"exp-%id%\"><div class=\"item__description\">%description%</div><div class=\"right clearfix\"><div class=\"item__value\">%value%</div><div class=\"item__percentage\">21%</div><div class=\"item__delete\"><button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button></div></div></div>';\n  } //Replacing the id,value and correct description.\n\n\n  newTextToBeString = textToBeString.replace('%id%', ele.id);\n  newTextToBeString = newTextToBeString.replace('%description%', ele.description);\n  newTextToBeString = newTextToBeString.replace('%value%', formatDisplay(ele.value, type)); //Insert the new object into DOM\n\n  document.querySelector(placeToInsert).insertAdjacentHTML('beforeend', newTextToBeString);\n};\nvar clearInputs = function clearInputs() {\n  var fields, fieldsArray;\n  fields = document.querySelectorAll(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].description + ' ,' + _base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].value);\n  fieldsArray = Array.prototype.slice.call(fields);\n  fieldsArray.forEach(function (current, index, array) {\n    current.value = '';\n  });\n  fields[0].focus();\n};\nvar displayBudget = function displayBudget(object) {\n  var type;\n  object.budget >= 0 ? type = 'inc' : type = 'exp';\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].totalBudget).textContent = formatDisplay(object.budget, type);\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].totalIncome).textContent = formatDisplay(object.totalInc, 'inc');\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].totalExpense).textContent = formatDisplay(object.totalExp, 'exp');\n\n  if (object.per > 0) {\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].percentageSelector).textContent = object.per + '%';\n  } else {\n    document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].percentageSelector).textContent = '***';\n  }\n};\nvar displayPercentages = function displayPercentages(percentage) {\n  var selector;\n  selector = document.querySelectorAll(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].percentageSelect);\n  nodeListForEach(selector, function (current, index) {\n    if (percentage[index] > 0) {\n      current.textContent = percentage[index] + '%';\n    } else {\n      current.textContent = '***';\n    }\n  });\n};\nvar diaplayDate = function diaplayDate() {\n  var now, months, month, year;\n  now = new Date();\n  months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];\n  month = now.getMonth();\n  year = now.getFullYear();\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].dateSelect).textContent = months[month] + ' ' + year;\n};\nvar deleteItem = function deleteItem(selectorID) {\n  var el = document.getElementById(selectorID);\n  el.parentNode.removeChild(el);\n};\nvar changeType = function changeType() {\n  var fields = document.querySelectorAll(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].type + ',' + _base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].description + ',' + _base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].value);\n  nodeListForEach(fields, function (current) {\n    current.classList.toggle('red-focus');\n  });\n  document.querySelector(_base__WEBPACK_IMPORTED_MODULE_0__[\"DOMSelector\"].btn).classList.toggle('red');\n};\n\n//# sourceURL=webpack:///./src/js/uicontroller.js?");
